...
END:VCARD`.trim()
    ...
    */
    ...
    conn.sendButtonDoc = async (jid, content, footerText, button1, id1, quoted, options) => {
      ...
      conn.sendMessage(jid, buttonMessage, { quoted, ephemeralExpiration: 86400, forwardingScore: 99999, isForwarded: false, ...options })
    }
    conn.send2ButtonDoc = async (jid, content, footerText, button1, id1, button2, id2, quoted, options) => {
        ...
        conn.sendMessage(jid, buttonMessage, { quoted, ephemeralExpiration: 86400, contextInfo: { mentionedJid: conn.parseMention(content + footerText), forwardingScore: 99999, isForwarded: false }, ...options, ephemeralExpiration: 86400 } )
    }
    ...
    conn.sendButton = async (jid, content, footerText, button1, id1, quoted, options) => {
        ...
        conn.sendMessage(jid, buttonMessage, { quoted, ephemeralExpiration: 86400, contextInfo: { mentionedJid: conn.parseMention(content + footerText), forwardingScore: 999999, isForwarded: false }, ...options })
    }
    ...
    conn.send3Button = async (jid, content, footerText, button1, id1, button2, id2, button3, id3, quoted, options) => {
        ...
        conn.sendMessage(jid, buttonMessage, { quoted, ephemeralExpiration: 86400, contextInfo: { mentions: conn.parseMention(content + footerText), forwardingScore: 99999, isForwarded: false }, ...options })
    }
    ...
    */
    ...
    conn.sendTemplateButtonFakeImg = async (jid, buffer, content, footerText, btn1, id1, options) => {
        ...
        conn.sendMessage(jid, key, { ephemeralExpiration: 86400, mentions: conn.parseMention(content + footerText), contextInfo: { forwardingScore: 99999, isForwarded: false }, ...options })
    }
    conn.send2TemplateButtonFakeImg = async (jid, buffer, content, footerText, btn1, id1, btn2, id2, quoted, options) => {
        ...
        conn.sendMessage(jid, key, { quoted, ephemeralExpiration: 86400, contextInfo: { mentions: conn.parseMention(content + footerText), forwardingScore: 9999, isForwarded: false } })
    }
    conn.send3TemplateButtonFakeImg = async (jid, buffer, content, footerText, btn1, id1, btn2, id2, btn3, id3, quoted, options) => {
        ...
        conn.sendMessage(jid, key, { quoted, ephemeralExpiration: 86400, contextInfo: { forwardingScore: 9999, isForwarded: false, mentions: conn.parseMention(content) } })
    }
